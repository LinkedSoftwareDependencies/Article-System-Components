...
\begin{tikzpicture}[
    ...
    \draw[->,thick,relation] (component) -- (class) node [right=0,midway,align=right] {rdfs:subClassOf};
    \draw[->,thick,relation] (component) -- (instance) node [right=0,midway,align=right] {rdfs:subClassOf};
    \draw[->,thick,relation,text width=14em] (component) -- (string) node [right=0.5,midway,align=right] {oo:componentPath};
    
    \draw[->,thick,relation] (class) -- (classAbstract) node [left=-1,midway,align=left] {rdfs:subClassOf};
    \draw[->,thick,relation] (class) -- (parameter) node [right=0,midway,align=right] {oo:parameter};
